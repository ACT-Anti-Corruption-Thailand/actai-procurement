<template>
  <NuxtLayout>
    <div>
      ...
      <div
        v-if="isLoadingOverall"
        class="fixed bg-black bg-opacity-50 inset-0 z-10 h-full text-white b1 flex justify-center items-center"
      >
        <svg
          aria-hidden="true"
          class="w-10 h-10 text-gray-200 animate-spin dark:text-white fill-red-500"
          viewBox="0 0 100 101"
          fill="none"
...
import { isLoadingOverall } from "~/store/loading";
