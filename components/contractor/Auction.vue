...
const removeParticipatedCompany = (item, i) => {
  //let d = participatedCompany.value.slice(1, participatedCompany.length);
  participatedCompany.value.splice(i, 1);
  ...
  <div v-else>
    ...
    <div v-else>
      <div class="bg-[#F5F5F5] rounded-t-md p-7">
        ...
        <div
          v-if="contracterParticipatedCompanyById.length > 0"
